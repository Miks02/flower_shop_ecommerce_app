...
namespace FlowerShop.Infrastructure.Migrations
{
    ...
    [Migration("20260908111600_RenameReviewToServiceReview")]
    partial class RenameReviewToServiceReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlowerShop.Domain.Entities.Notifications.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlowerShop.Domain.Entities.Notifications.NotificationRecipient", b =>
                {
            ...
            modelBuilder.Entity("FlowerShop.Domain.Entities.Orders.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlowerShop.Domain.Entities.ProductReviews.ProductReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlowerShop.Domain.Entities.ServiceReviews.ServiceReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlowerShop.Domain.Entities.Deliverers.Deliverer", b =>
                {
                    b.HasOne("FlowerShop.Domain.Entities.IdentityUser.User", "User")
                        .WithOne("Deliverer")
                        .HasForeignKey("FlowerShop.Domain.Entities.Deliverers.Deliverer", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FlowerShop.Domain.Entities.Notifications.NotificationRecipient", b =>
                {
                    b.HasOne("FlowerShop.Domain.Entities.Notifications.Notification", "Notification")
                        .WithMany("Recipients")
            ...
            modelBuilder.Entity("FlowerShop.Domain.Entities.ServiceReviews.ServiceReview", b =>
                {
                    b.HasOne("FlowerShop.Domain.Entities.Orders.Order", "Order")
                        ...
                        .HasForeignKey("FlowerShop.Domain.Entities.ServiceReviews.ServiceReview", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FlowerShop.Domain.Entities.IdentityUser.User", "Reviewer")
